...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/movieForm.css')); ?>">
    <title>Star Rail</title>
</head>
<body class="d-flex justify-content-center align-items-center min-vh-100 background-body">
    <form action="<?php echo e(route('destroy', ['id' => $personagem->id])); ?>" method='POST' class="border p-5 rounded background-form">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\StarRailCaracters\resources\views/delete.blade.php ENDPATH**/ ?>